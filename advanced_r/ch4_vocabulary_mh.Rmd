...
Are `sink` and `capture.output` mainly for non-RStudio R use? 
Does anybody try to capture output in non-report form, for future use? (E.g. what if libraries used for analysis become outdated later and you want a record of output?)
